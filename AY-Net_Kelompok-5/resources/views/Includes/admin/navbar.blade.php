                ...
                <ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="{{ url('img/administrator/'.Auth::user()->foto_profil) }}" width="35" alt="pic">
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="{{route('logout')}}" class="dropdown-item ai-icon" onclick="return confirm('Anda yakin ingin logout?')">
                    ...
                    <!-- <li class="nav-item dropdown">
						<img src="{{url('frontend/images/profile/pic1.jpg')}}" width="35" alt="">
